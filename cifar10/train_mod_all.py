...
def train(args):
   ...
   # #  print(model.state_dict().keys())
    ...
    for i in range(args.epochs):
        ...
        stime_snow = time.time()
        weights_snow = train_snow (train_loader, device,optimizer,model,CE_loss, config_snow, lr_schedule, i)
        etime_snow = time.time()


        print('snow training weights', weights_snow, 'using time:', (etime_snow-stime_snow))        
