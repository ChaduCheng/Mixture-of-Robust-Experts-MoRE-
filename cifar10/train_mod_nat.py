...
def train(args):
    ...
    model_loc1 = './trained_model/ckptnat_resnet18_cifar_fog_t_0.12_light_0.8.pth'
    model_loc2 = './trained_model/ckptnat_resnet18_cifar_fog_t_0.15_light_0.6.pth'
    model_loc3 = './trained_model/ckptnat_resnet18_cifar_snow_bight_2.0.pth'
    model_loc4 = './trained_model/ckptnat_resnet18_cifar_snow_bight_2.5.pth'
   ...
   # #  print(model.state_dict().keys())
    ...
    for i in range(args.epochs):
        ...
        weights_fog = train_fog (train_loader, device,optimizer,model,CE_loss, config_fog, lr_schedule, i)
        ...
        weights_snow = train_snow (train_loader, device,optimizer,model,CE_loss, config_snow, lr_schedule, i)
