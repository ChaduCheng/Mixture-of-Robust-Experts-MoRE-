...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 25 17:56:07 2020
...
from train_mod_three import train
...
def get_args():
    ...
    args.lr = 0.001
    args.gpu_ids = '0'
    #args.checkpoint_loc = './checkpoint/ckptMoE_resnet_cifar_clean+adv+nat_test1.pth'
    #args.checkpoint_loc = './trained_model/ckptl2_alex_cifar_50.pth'
    args.checkpoint_loc = './checkpoint/ckptMoE_resnet_cifar_clean+l2+fog.pth'
    args.num_experts = 3
    args.training = True
    args.testing = False
