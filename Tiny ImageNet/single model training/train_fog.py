...
def train_fog (train_loader, device,optimizer,model,CE_loss):
    for images, labels in tqdm(train_loader):

            for i in range(0,images.shape[0]):
                 # print(images[i])
                  images_fog = add_fog(images[i], 0.13, 0.6)
                  #print(images_fog)
                  images[i] = images_fog        
...
def val(val_loader, device, model,  basic_model,\
    ...
    for images_3, labels in tqdm(val_loader):
            ...
            for i in range(0,images_3.shape[0]):
                 # print(images[i])
                  images_snow = add_snow(images_3[i])
                  #print(images_fog)
...
def train(args):
    ...
    for i in range(args.epochs):
        ...
        train_fog (train_loader, device,optimizer,model,CE_loss)
