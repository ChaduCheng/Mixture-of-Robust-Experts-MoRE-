...
def train(args):
    ...
    config_l2 = dict(config_l2_80 = config_l2_80)
  ...
  #  config_snow = dict(brightness_1 = brightness_1, brightness_2 = brightness_2)
    ...
    #model_loc1 = './trained_model/ckptl2_alexnet_timagenet_60_255.pth'
    model_loc2 = './trained_model/ckptl2_resnet18_timagenet_80_255.pth'
    # model_loc3 = './trained_model/ckptlinf_alexnet_timagenet_4_255.pth'
    # model_loc4 = './trained_model/ckptlinf_alexnet_timagenet_8_255.pth'
    # model_loc5 = './trained_model/ckptnat_resnet18_timagenet_fog_t_0.12_light_0.8.pth'
    model_loc6 = './trained_model/ckptnat_resnet18_timagenet_fog_t_0.13_light_0.6.pth'
    # model_loc7 = './trained_model/ckptnat_resnet18_timagenet_snow_b_2.0.pth'
    # model_loc8 = './trained_model/ckptnat_resnet18_timagenet_snow_b_2.5.pth'
   ...
   # #  print(model.state_dict().keys())
    ...
    # utils.load_model(model_loc1, model.experts[2])
    # utils.load_model(model_loc2, model.experts[3])
    # utils.load_model(model_loc3, model.experts[4])
    # utils.load_model(model_loc4, model.experts[5])
    # utils.load_model_nat(model_loc5, model.experts[6])
    # utils.load_model_nat(model_loc6, model.experts[7])
    # utils.load_model_nat(model_loc7, model.experts[8])
    # utils.load_model_nat(model_loc8, model.experts[9])
    ...
    # utils.load_model(model_loc4, model.experts[5])
    # utils.load_model_nat(model_loc5, model.experts[6])
    utils.load_model_nat(model_loc6, model.experts[2])
    # utils.load_model_nat(model_loc7, model.experts[2])
    # utils.load_model_nat(model_loc8, model.experts[2])    
    ...
    for i in range(args.epochs):
        ...
        print('l2 training weights', weights_l2, 'running time', (end_l2-start_l2)) 
        ...
        print('nat training weights', weights_nat, 'runing time:', (end_nat-start_nat))
        ...
        print('after fog training weights(final):', weights_fog, 'running time:', (end_fog-start_fog))         
        ...
        # print('snow training weights', weights_snow, 'running time:', (end_snow-start_snow))           
        ...
        if (acc_nat_1 + acc_nat_2 + sum(acc_l2) + sum(acc_snow))/6 > best_acc_aver:
                print('saving..')
                ...
                best_acc_aver = (best_acc_nat_1 + best_acc_nat_2 + sum(best_acc_l2)  \
                                  +  sum(best_acc_snow))/6
