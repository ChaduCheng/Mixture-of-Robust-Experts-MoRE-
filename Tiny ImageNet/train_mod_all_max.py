...
def train(args):
    ...
    model_loc1 = './trained_model/ckptl2_resnet18_timagenet_60_255.pth'
    model_loc2 = './trained_model/ckptl2_resnet18_timagenet_80_255.pth'
    model_loc3 = './trained_model/ckptlinf_resnet18_timagenet_4_255.pth'
    model_loc4 = './trained_model/ckptlinf_resnet18_timagenet_8_255.pth'
   ...
   # #  print(model.state_dict().keys())
    ...
    for i in range(args.epochs):
        ...
        train_fog (train_loader, device,optimizer,model,CE_loss, config_fog)
        ...
        train_snow (train_loader, device,optimizer,model,CE_loss, config_snow)
